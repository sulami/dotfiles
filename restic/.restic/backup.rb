...
ENV['B2_ACCOUNT_ID'] = `pass backblaze-b2/account-id`.strip
ENV['B2_ACCOUNT_KEY'] = `pass backblaze-b2/account-key`.strip
ENV['RESTIC_REPOSITORY'] = `pass restic/target`.strip
ENV['RESTIC_PASSWORD'] = `pass restic/password`.strip
