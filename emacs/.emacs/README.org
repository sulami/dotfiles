...
** All the icons
Adds some icons. I use them mainly in ~dired~, where they help provide
an overview.
...
* Avy
This allows me to jump to any point on the screen.
...
Also only show the current clock period in the mode line.
#+begin_src emacs-lisp :tangle yes
(setq org-clock-persist t
      org-clock-mode-line-total 'current)

(advice-add 'org-clock-in :after 'org-save-all-org-buffers)
(advice-add 'org-clock-in-last :after 'org-save-all-org-buffers)
