...
(use-package counsel-projectile
  ...
  ;; When switching projects, default to finding a file.
...
(use-package magit
  ...
  (sulami/project-directory "~/build")
  :config
  ...
  (defun sulami/clone-repo (url)
    "Clone the repo at URL into `sulami/project-directory'"
    (interactive "sURL: ")
    (let* ((repo-name (magit-clone--url-to-name url))
           (target-dir (concat sulami/project-directory "/" repo-name)))
