...
(defun sulami/load-theme-advice (theme &optional no-confirm no-enable)
...
(setq org-directory "~/Documents/Notes/"
      org-agenda-files (list org-directory
                             "~/.emacs/README.org")
      org-agenda-tag-filter-preset '("-archived"))
#+end_src
*** Capture
#+begin_src emacs-lisp :tangle yes
...
** TODO figure out company completion inside snippet expansion
~tab~ does both jump to the next placeholder and select a completion,
which can be annoying.
** TODO emacsclient setup
I'd like to have emacsclient open in a new, clean frame, and clean up
upon termination.
** TODO file away org-mode subtrees into files via prompt
So that I can get stuff from my inbox into better files.
** Packages to look into
*** TODO forge
github stuff. seems to use sqlite, which I'm dubious about
*** TODO vdiff
like vdiff. was a bit dodgy when I tried it last time, got half-stuck
inside the mode
