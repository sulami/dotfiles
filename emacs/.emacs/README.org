...
(use-package evil-search-highlight-persist
  ...
  (evil-ex-define-cmd "noh[lsearch]" #'sulami/isearch-nohighlight)
...
(use-package erc
  ...
  :custom
  (erc-nick "sulami")
  (erc-password (string-trim (shell-command-to-string "pass freenode/password")))
...
(use-package tide
  ...
  (defun sulami/tide-setup ()
    ...
    (eldoc-mode +1))
  :hook
  ;; TODO activate tide in tsx files, which are web-mode
