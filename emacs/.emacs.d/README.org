...
Hide the TUI menu bar and enable mouse support in terminal mode.
...
Stolen from [[https://github.com/stig/dotfiles/blob/trunk/Emacs.org#ediff-picking-both-sides-in-a-conflict][Stig]].
...
The primary language at =$DAYJOB=. =rspec-mode= adds =imenu= support
for RSpec.
